...
This is a fun little mod I made because I started playing Minecraft (Java) on an 16:10 Monitor while now I use a 16:9 one.
...
There are still many issues even in vanilla (screens sometimes being cut off, mouse behaving weird with scrollbars, ...) so I'll try to fix them in future releases.
